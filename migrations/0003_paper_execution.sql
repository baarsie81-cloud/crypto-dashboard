...
CREATE TABLE IF NOT EXISTS public.paper_trades (
  ...
  virtual_equity_eur numeric NOT NULL DEFAULT 1000,
  base_risk_pct numeric NOT NULL DEFAULT 1,
  risk_budget_eur numeric NOT NULL,
  actual_risk_eur numeric NOT NULL,
  ...
  close_reason text,
  gross_result_eur numeric,
  fees_eur numeric NOT NULL DEFAULT 0,
  slippage_eur numeric NOT NULL DEFAULT 0,
  net_result_eur numeric,
  result_r numeric,
